...
class AuthVerificationResetViewBody extends StatelessWidget {
  const AuthVerificationResetViewBody({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Center(
            child: OTPTextField(
                ...
                onCompleted: (pin) {
                  AuthFunctions.goToAuthPages('resetPassword');
                }),
          ),
          SizedBox(
